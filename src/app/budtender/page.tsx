...
const recentOrders = [
  { id: '#G12346', customer: 'Alice Johnson', total: 85.00, status: 'Pending', items: 3 },
  { id: '#G12345', customer: 'Kim L.', total: 75.50, status: 'Completed', items: 2 },
  { id: '#G12344', customer: 'Bob Williams', total: 50.00, status: 'Completed', items: 2 },
  { id: '#G12343', customer: 'Charlie Brown', total: 150.25, status: 'Pending', items: 5 },
];
