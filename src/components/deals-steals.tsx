...
const deals = [
  { name: 'Blue Dream', hint: 'sativa flower', tag: 'New' },
  { name: 'Sour Diesel', hint: 'sativa plant', tag: 'Popular' },
  { name: 'OG Kush', hint: 'hybrid bud', tag: '5% Off' },
  { name: 'Granddaddy Purple', hint: 'indica flower', tag: 'Just In' },
  { name: 'White Widow', hint: 'hybrid flower', tag: '10 Left' },
  { name: 'AK-47', hint: 'hybrid plant' },
  { name: 'Jack Herer', hint: 'sativa bud', tag: '10% Off' },
  { name: 'Green Crack', hint: 'sativa plant' },
  { name: 'Pineapple Express', hint: 'hybrid flower', tag: '5 Left' },
  { name: 'Girl Scout Cookies', hint: 'indica bud', tag: 'Popular' },
  { name: 'Northern Lights', hint: 'indica plant' },
  { name: 'Bubba Kush', hint: 'indica flower', tag: 'New' },
  { name: 'Durban Poison', hint: 'sativa bud' },
  { name: 'Maui Wowie', hint: 'sativa plant', tag: 'Just In' },
  { name: 'Trainwreck', hint: 'hybrid flower', tag: '5% Off' },
  { name: 'Chemdawg', hint: 'hybrid bud' },
  { name: 'Super Lemon Haze', hint: 'sativa plant', tag: '10 Left' },
  { name: 'Strawberry Cough', hint: 'sativa flower' },
  { name: 'Gorilla Glue #4', hint: 'hybrid bud', tag: 'Popular' },
  { name: 'Zkittlez', hint: 'indica flower', tag: '10% Off' },
];
