        ...
        <div className="wrapper">
            ...
            <div className={cn("profile-card js-profile-card", isMessageActive && "active")}>
                <div className="profile-card__img">
                    <Image src={profile.avatarUrl} alt={profile.firstName} width={150} height={150} />
                </div>
                ...
                <div className="profile-card__cnt js-profile-cnt">
                    ...
                    <div className="profile-card-social">
                        {socialLinks.map(link => (
                             <a href={link.href} className={`profile-card-social__item ${link.name.toLowerCase()}`} target="_blank" key={link.name}>
                ...
                <div className={cn("profile-card-message js-message", isMessageActive && "active")}>
                    <form className="profile-card-form" onSubmit={handleSendMessage}>
                        <div className="profile-card-form__container">
                            <Textarea placeholder="Say something..." value={message} onChange={(e) => setMessage(e.target.value)} />
                        </div>
